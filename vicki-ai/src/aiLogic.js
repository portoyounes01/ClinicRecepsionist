...
async function generateCallSummary(history, patient) {
  try {
    ...
    const summaryPrompt = [
      ...
      '- "outcome": "booked" | "cancelled" | "info_given" | "transferred" | "no_action" | "abandoned". DEFINITIONS:',
      '    • "info_given": Vicki ANSWERED the patient\'s question or gave the information/help they asked for (hours, location, services, price policy, what to bring, a yes/no, etc.) WITHOUT transferring — i.e. she resolved the request herself. This is a SUCCESS even if no appointment was booked.',
      '    • "no_action": the caller gave no real request, was silent, or hung up before Vicki could help — nothing substantive was answered or done. Use this ONLY when Vicki did NOT resolve anything; if she answered the question, use "info_given".',
      '    • "transferred": the call was handed to a human. "abandoned": the caller dropped mid-request.',
